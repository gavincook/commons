 ...
 *
 * @author GavinCook
 * @version $Id: AssertUtils.java, v0.0.1 2017-07-27 下午3:07 GavinCook Exp $$
 */
public class AssertUtils {
    ...
    /**
     * 断言字符串是否为空白，若为空白抛出异常{@link AssertionError}，具体参见{@link StringUtils#isBlank(String)}
     *
     * @param str 需要检查的对象
     */
    public static void assertStringNotBlank(String str) {
        assertTrue(!StringUtils.isBlank(str), null);
    }
    ...
    public static void assertStringNotBlank(String str, String message) {
        assertTrue(!StringUtils.isBlank(str), message);
    }
